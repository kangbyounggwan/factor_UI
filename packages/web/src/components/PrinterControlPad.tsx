    ...
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col space-y-4 text-xs overflow-hidden">
        ...
        <ScrollArea className="flex-1">
          <Accordion type="multiple" defaultValue={["axis", "temperature"]} className="space-y-2">
            {/* 축 제어 */}
            ...
            <AccordionItem value="temperature" className="border rounded-lg px-3">
              ...
              <AccordionContent className="pb-3">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Label className="text-xs min-w-[50px]">{t('control.extruder')}</Label>
                    <Input
                      type="number"
                      value={extruderTemp}
                  ...
                  <div className="flex items-center gap-2">
                    <Label className="text-xs min-w-[50px]">{t('control.heatingBed')}</Label>
                    <Input
                      type="number"
                      value={bedTemp}
            ...
            <AccordionItem value="extruder" className="border rounded-lg px-3">
              <AccordionTrigger className="py-2 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{t('control.extruderControl')}</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="pb-3">
                <div className="space-y-2">
            ...
            <AccordionItem value="fan" className="border rounded-lg px-3">
              <AccordionTrigger className="py-2 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{t('control.fanSpeed')}</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="pb-3">
                <div className="space-y-2">
