...
import { Camera, Play, Pause, RotateCw, Maximize2, Square } from "lucide-react";
  ...
  return (
    <Card
      className={
        ...
        `min-h-[38vh] md:min-h-[44vh] transition-[min-height] duration-200`
      }
    >
      <CardHeader>
      ...
      <CardContent>
        <div className="space-y-4">
          {/* 카메라 피드 영역 또는 시작 버튼 */}
          <div className="relative bg-black rounded-lg overflow-hidden min-h-[220px] h-[32vh] md:h-[36vh]">
            {isStreaming ? (
              isConnected ? (
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute top-3 right-3 z-10">
                    <Button
                      ...
                      className="h-8 bg-black/50 text-white hover:bg-black/60 border-white/30"
                    >
