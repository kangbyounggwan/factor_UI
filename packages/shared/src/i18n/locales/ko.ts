export default {
  ...
  subscription: {
    ...
    purchaseSuccessDesc: "구독이 활성화되었습니다.",
    purchaseError: "구독 실패",
    purchaseFailed: "구독 처리에 실패했습니다.",
    restoreSuccess: "복원 성공",
    restoreSuccessDesc: "구독이 복원되었습니다.",
    restoreError: "복원 실패",
    restoreFailed: "구매 복원에 실패했습니다.",
    noSubscriptionFound: "복원할 구독이 없습니다.",
    alreadySubscribed: "이미 사용 중인 플랜입니다.",
    contactRequired: "문의 필요",
    enterpriseContact: "Enterprise 플랜은 별도 문의가 필요합니다.",
    downgradeConfirm: "Basic 플랜으로 변경하시겠습니까?",
    webOnly: "PC 웹에서 구독하기",
    webOnlyDesc: "구독은 PC 웹 브라우저에서만 가능합니다. 웹사이트를 방문해주세요.",
    subscribeOnWeb: "웹에서 구독하기",
    supportType: "지원 유형",
